...
<div class="container-fluid">
  <div class="row">
    <div class="col-6 d-flex flex-column justify-content-center gap-5" style="background-color: #f6f7f7b6; height:60vh">
      <h1 style="font-size: 4.5rem; color: #000ca6; font-weight:600" class="ms-4">Nikmati Pengalaman Perjalanan Terbaik dengan kami</h1>
...
<div class="container-fluid d-flex justify-content-between">
  ...
  <div class="card text-center border-0 m-3" style="width: 60rem;">
    ...
    <img src="asset/hiace 3.png" class="card-img-top" alt="..." style="height: 29rem">
    <div class="card-body d-flex flex-column align-items-center">
      <h5 class="card-title">Toyota</h5>
