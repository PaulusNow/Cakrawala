...
<div class="container-fluid">
  <div class="row align-items-center" style="margin-left: 50px">
    <div class="col-md-6">
        ...
        <a href="#selengkapnya" class="btn rounded-pill shadow" style="background-color: #fe8730; width:25%; color:white; font-weight:700">Selengkapnya</a>
    </div>
    <div class="col-md-6">
      <img src="asset/img_card.png" alt="" width="850">
    </div>
  </div>
</div>
<!-- End Card #1-->
  ...
  <div class="row mx-auto">
    <div class="col-md-6">
      ...
      <div class="card text-center">
        ...
        <p style="font-size: 16px; font-weight:700">Mobil berjenis MPV yang diproduksi oleh Toyota yang dirancang untuk mampu mengangkut 7 orang penumpang</p>
    ...
    <div class="col-md-6">
      ...
      <div class="card text-center">
        ...
        <p style="font-size: 16px; font-weight:700">Mobil berjenis MPV yang diproduksi oleh Toyota yang dirancang untuk mampu mengangkut 16 orang penumpang</p>
        <a href="#" class="btn p-2 mx-auto">Lihat Detail</a>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-4 text-center">
      <div class="reviewcard">
          <h1 class="fw-bold mt-3 p-4">Louis Maxi</h1>
    ...
    <div class="col-md-4 text-center">
      <div class="reviewcard">
          <h1 class="fw-bold mt-3 p-4">Yoseph Hakim</h1>
          ...
          <p style="font-weight: 500" class="p-5">Harga termasuk jauh lebih murah dari pada rentcar lain, mantap pokoknya</p>
        </div>
      </div>
    <div class="col-md-4 text-center">
      <div class="reviewcard">
          <h1 class="fw-bold mt-3 p-4">Aldo</h1>
