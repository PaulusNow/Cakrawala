...
@section('container')
    ...
    <div class="coverpusat">
        ...
        <div id="id1-prosedur" class="prosedur">
            <p>Pemesanan : <br> Pemesanan dari jam dan tanggal pesanan dibuat, Anda akan dapat memilih <i>jenis kendaraan,
        ...
        <div id="id4-prosedur" class="prosedur">
            <p>Kita akan bertanggung jawab penuh apabila proses pemesanan dan pembayaran sudah selesai akan tetapi mobil
                ...
                menggantikan mobil lain sesuai dengan harga yang dipesan/kami bersedia mengembalikan uang pemesanan sesuai
